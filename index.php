...
<head>
    ...
    <title>Loja da Nintendo</title>
</head>
<body>
    <header>
        <h1>Nintendo e-Shop</h1>
    </header>
    <main>
        <section id="intro">
        ...
        <section id="anime-list">
            ...
            <table>
                <tr>
                    <td><img src="image/jogo1.jpg" ></td>
                    <td><img src="image/jogo2.jpg" ></td>
                    <td><img src="image/jogo3.png" ></td>
                </tr>
            </table>
        </section>
        <section id="outro">
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Nintendo já vendeu mais de 5.5 mil milhões de videojogos e mais de 800 milhões de consolas em todo o mundo. Desde o lançamento da Nintendo Entertainment System™ há mais de 30 anos e até ao futuro, a missão contínua da Nintendo é a criação de experiências de entretenimento únicas capazes de colocar sorrisos nos rostos de pessoas em todo o mundo.
            </p>
        </section>
    </main>
    <footer>
        <a href="php/etapa2.php">Comprar</a>
    </footer>
</body>
</html>